...
const webpackConf = require("./scripts/webpack.config");
...
gulp.task("bundle-tpls", function() {
    return gulp.src(config.html.src)
        .pipe(templateCache({ module: "the-world.tpls", standalone: true, filename: "the-world.tpls.js" }))
